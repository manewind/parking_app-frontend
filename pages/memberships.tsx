      ...
      try {
        ...
        if (axios.isAxiosError(error)) {
          if (error.response?.status === 500) {
            setErrorMessage('У вас уже есть активный абонемент.');
          ...
          console.error('Неизвестная ошибка при отправке запроса:', error);
          setErrorMessage('Произошла ошибка при обработке запроса.');
        }
      }
        ...
        {isConfirmModalOpen && selectedMembership && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
              ...
              <p className="mb-4 text-black text-center text-xl">
              ...
              <div className="flex justify-around">
                <button
                  ...
                  className="py-2 px-8 bg-green-500 text-white rounded-lg hover:bg-green-600 transition"
                >
                  Да
                </button>
                <button
